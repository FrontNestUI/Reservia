...
export default function SearchBar(){
    ...
    return(<div className="flex w-full h-11 justify-between border-2 border-gray-500 rounded-2xl">
        ...
        <button className="bg-blue-600 py-2 px-3 rounded-xl w-1/8 cursor-pointer "><FontAwesomeIcon style={'font-size: 1em'} size="lg" icon={faMagnifyingGlass}/></button>
    </div>)
}